<div class="p-6">
    <h2 class="text-xl font-bold mb-6 text-center text-gray-900 dark:text-white">
        Barcode Labels <span class="text-sm text-gray-500 dark:text-gray-400">({{ $inventories->count() }} items)</span>
    </h2>
    ...
    <div class="flex justify-center space-x-3 mt-6">
        <a href="{{ route('print.barcodes', ['ids' => $inventories->pluck('id')->join(',')]) }}" target="_blank"
